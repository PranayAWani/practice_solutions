...
HD_PWD='D:/Pranay/VLSI/practice/practice_solutions/multiplexer_8bit/multiplexer_8bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_8_mux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bit_8_mux.tcl -notrace

...
HD_PWD='D:/Pranay/VLSI/practice/practice_solutions/multiplexer_8bit/multiplexer_8bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_8_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit_8_mux.tcl

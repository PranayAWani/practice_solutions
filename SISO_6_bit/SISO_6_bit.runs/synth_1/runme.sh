...
HD_PWD='D:/Pranay/VLSI/practice/practice_solutions/SISO_6_bit/SISO_6_bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log siso_6_bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source siso_6_bit.tcl

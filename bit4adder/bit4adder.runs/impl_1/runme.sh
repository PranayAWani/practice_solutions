...
HD_PWD='D:/Pranay/VLSI/practice/practice_solutions/bit4adder/bit4adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_4_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bit_4_adder.tcl -notrace

...
HD_PWD='D:/Pranay/VLSI/practice/practice_solutions/bit4adder/bit4adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_4_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit_4_adder.tcl

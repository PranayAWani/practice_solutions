...
HD_PWD='D:/Pranay/VLSI/practice/practice_solutions/bit_4_mux/bit_4_mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_4_mux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit_4_mux.tcl

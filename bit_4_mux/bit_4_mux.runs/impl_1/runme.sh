...
HD_PWD='D:/Pranay/VLSI/practice/practice_solutions/bit_4_mux/bit_4_mux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_4_mux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bit_4_mux.tcl -notrace
